...
@Component({
  selector: 'app-view-user-helpdesk',
  templateUrl: './view-user-helpdesk.component.html',
  styleUrls: ['./view-user-helpdesk.component.css']
})
export class ViewUserHelpdeskComponent implements OnInit {
